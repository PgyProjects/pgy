...
function(a) {
    ...
    c.view = function(a, f) {
        ...
        function() {
            ...
            a
        } () + "</div>" + "</div>" + "</div>" + c.viewtb + '<div class="laydate_bottom">' + '<ul id="laydate_hms">' + '<li class="laydate_sj">时间</li>' + "<li><input readonly>:</li>" + "<li><input readonly>:</li>" + "<li><input readonly></li>" + "</ul>" + 
        ...
        '<a id="week" href="ss?shu=近一周&leixing=time">近一周</a>'+
        '<a id="month" href="ss?shu=近一月&leixing=time">近一月</a>'+'</div>'
        + (b.isv ? '<a href="http://sentsin.com/layui/laydate/" class="laydate_v" target="_blank">laydate-v' + laydate.v + "</a>": "") + "</div>", d.body.appendChild(i), c.box = g("#" + h[0]), c.events(), i = null),
        c.follow(c.box),
