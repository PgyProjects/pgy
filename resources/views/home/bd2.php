...
<body ontouchstart>
	...
	<form action="<?php echo site_url('home/bd2')?>" method="post">
...
<div class="kongbai2"></div>
			...
			<div class="weui-cell">
					...
					<div class="du-botton"> <div class="down"><img id="du" src="<?php echo base_url('public/')?>icon/+.png" alt=""></div>
...
var index = 1;
 $('.down').click(function() {
			...
			if(index == '1') {
				...
				$('.yincang').slideToggle();
					$('#du').attr('src','<?php echo base_url('public/')?>icon/-.png')
                    $('#tishi-01').html('');
