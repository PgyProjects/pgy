			...
			<ul>
				...
				<li class="edu">
					<div class="edu_indx">
						...
						<div class="tishi">
							<a href="<?php echo asset('home/index_2') ?>"><img src="<?php echo asset('assets/weixin/img/tanhao.png') ?>"/></a>
							<p>仅支持<span class="colorE4">500</span>元以上贷款，快去<a href="<?php echo asset('home/index_2') ?>"><span class="colorE4">提额</span></a>吧</p>
						</div>
					</div>
				</li>
				<li class="thirdLi">
