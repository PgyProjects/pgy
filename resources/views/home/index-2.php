...
<div class="xiaoguo" id="xiaoguo">
         <img id="zmf" src="<?php echo base_url('public/')?>icon/zmf.png" alt=""><!--z芝麻分-->
          </div>
        </li>
	...
	<li >
  <div class="xiaoguo" id="xiaoguo">
	   			<img id="yys" src="<?php echo base_url('public/')?>icon/yidong2.png"> <!--运营商-->
           </div>
	   		</li>
...
<li>
<div class="xiaoguo" id="xiaoguo">
<img id="jingdong" src="<?php echo base_url('public/')?>icon/jingdong2.png" alt=""><!--京东-->
</div>
</li>
	   	...
	   	<li>
      <div class="xiaoguo" id="xiaoguo">
	   		<img id="taobao" src="<?php echo base_url('public/')?>icon/taobao2.png" alt="">
        </div>
	   	</li>
